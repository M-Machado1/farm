...
# Sistema de Controle de Inventário - Fazenda Digital
...
6. Em qualquer prompt durante um cadastro, digite `back` para cancelar a operação.
...
- `data/inputs.json`
- `data/movements.json`
- `data/report.txt` (gerado ao pedir relatórios)